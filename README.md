...
DEPLOY_HOSTNAME=us-east-1.galaxy-deploy.meteor.com meteor deploy --settings './settings.json' tadkim.meteorapp.com


DEPLOY_HOSTNAME=us-east-1.galaxy-deploy.meteor.com meteor deploy [stuckyi-menstrualcup] --settings './settings.json'